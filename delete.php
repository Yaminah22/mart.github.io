...
<body>
    ...
    <div id="mainContainer">
        ...
        <div class="mainDiv">
            ...
            <div class="subDiv">
                <form method="POST">
                    ...
                    <input class="inputField" type="email" name="email" placeholder="Customer Email" required>
        ...
        if (isset($_POST['deleteCustomer'])) {
            $query = "SELECT * FROM `customers` WHERE username='$_POST[c_name]' AND customer_email='$_POST[email]'";
            $result = mysqli_query($con, $query);
            if ($result) {
                if (mysqli_num_rows($result) == 1) {
                    $bdelete = "DELETE FROM `customers` WHERE `username`='$_POST[c_name]' AND customer_email='$_POST[email]' ";
                    $run = mysqli_query($con, $bdelete);
                    if ($run) {
